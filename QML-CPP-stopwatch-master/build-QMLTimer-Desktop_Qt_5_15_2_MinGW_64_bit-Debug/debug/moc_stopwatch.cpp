...
#include <memory>
#include "../../QML-CPP-stopwatch-master/stopwatch.h"
...
QT_MOC_LITERAL(1, 10, 14), // "displayChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "start"
QT_MOC_LITERAL(4, 32, 4), // "stop"
QT_MOC_LITERAL(5, 37, 5), // "reset"
QT_MOC_LITERAL(6, 43, 6), // "toggle"
QT_MOC_LITERAL(7, 50, 5), // "value"
QT_MOC_LITERAL(8, 56, 7), // "timeout"
QT_MOC_LITERAL(9, 64, 7) // "display"

    },
    "Stopwatch\0displayChanged\0\0start\0stop\0"
    "reset\0toggle\0value\0timeout\0display"
};
...
void Stopwatch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->toggle((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Stopwatch::displayChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setDisplay(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
